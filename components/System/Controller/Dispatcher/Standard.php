 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class System_Controller_Dispatcher_Standard extends Zend_Controller_Dispatcher_Abstract
{
    /**
...
//        $stringResponseBody = $systemCache->load($stringCacheName);
//
...
//	        $systemCache->save($response->getBody(), $stringCacheName);        	
//        }
